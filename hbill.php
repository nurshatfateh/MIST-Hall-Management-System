...
if (isset($_SESSION['id']) && isset($_SESSION['user_name'])) {
    ...
    $query = "SELECT * FROM hallbill where STUDENTID=$code";
    ...
    $aa = oci_fetch_array($stid2, OCI_RETURN_NULLS + OCI_ASSOC);
...
<table class="table ">
    ...
    <h1 class="text-center mt-5 mb-5">Transactions</h1>
            ...
            <thead class="table-dark mt-5">
              ...
              <th scope="col">DATE</th>
                ...
                <th scope="col">HALL Charge (TK)</th>
...
?>
              ...
              <tr>
              <th scope="row"><?php echo $row["HALL_DATE"];?></th>
              <td><?php echo $aa["NAME"];?></td>
              <td><?php echo $aa["STUDENTID"];?></td>
              <td><?php echo $aa["ROOMNO"];?></td>
              <td><?php echo $aa["HALLID"];?></td>
           
              <th scope="row"><?php echo $row["HALL_BILL"];?></th>
